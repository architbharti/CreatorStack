...
const Landing = () => {
  ...
  return (
    <div className='px-4 sm:px-20 xl:px-20 relative inline-flex flex-col w-full justify-center bg-[url(/gradientBackground.png)] bg-no-repeat min-h-screen'>
        ...
        <div className='text-center mb-6'>
            ...
            <p className='mt-4 max-w-xs sm:max-w-lg 2xl:max-w-xl m-auto max-sm:text-sm text-gray-600'>Transform your content creation with out suite of preminum AI tools.Write articles , generate images , and enhance your workflow.</p>
        </div>
